...
const TARGET_EVENT = "Digital Marketing Evolution";
...
const transformDigitalMarkettingEvolutionOrders = (orders) => {
...
export const fetchDigitalMarketingEvolutionXOrders = async () => {
  let allOrders = [];
  let nextCursor = null;
