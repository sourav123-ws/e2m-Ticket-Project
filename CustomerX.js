...
const transformCustomerXOrders = (orders) => {
...
export const fetchCustomerXOrders = async () => {
  let allOrders = [];
  let nextCursor = null;
  ...
  try {
    ...
    const transformedOrders = transformCustomerXOrders(subscriptionXOrders);
