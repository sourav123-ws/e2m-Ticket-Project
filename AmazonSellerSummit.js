...
const TARGET_EVENT = "Amazon Sellers Summit";
...
const transformAmazonOrders = (orders) => {
...
export const fetchAmazonSellerSummitOrders = async () => {
  let allOrders = [];
  let nextCursor = null;
